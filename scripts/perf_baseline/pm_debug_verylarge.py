...
# worst VERY_LARGE + MEDIUM losers from perf-baseline-all (PM/auto < 0.9)
SHAPES = [
    (4096, 16384,  5120, "MEDIUM-llama4"),      # 0.823
    (4096, 32768,  5120, "VERY_LARGE-llama4"),  # 0.865
    (16384, 8192, 28672, "VERY_LARGE-fp8"),     # 0.874
    (4096,  7168, 16384, "MEDIUM-deepseek"),    # 0.878
    (4096,  4096,  4096, "MEDIUM-fp8"),         # 0.915 (canonical square)
]
